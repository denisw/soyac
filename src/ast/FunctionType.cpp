...
FunctionType* FunctionType::_get(
    Type* returnType, NodeList<Type>* parameterTypes)
{
...
FunctionType::FunctionType(Type* returnType, NodeList<Type>* parameterTypes)
...
void* FunctionType::visit(Visitor* v) { return v->visitFunctionType(this); }
...
Type* FunctionType::returnType() const { return mReturnType.target(); }

FunctionType::parameterTypes_iterator FunctionType::parameterTypes_begin() const
{
    return mParameterTypes->begin();
}

FunctionType::parameterTypes_iterator FunctionType::parameterTypes_end() const
{
