...
Function::parameters_iterator
Function::parameters_begin() const
{
...
Function::type() const
{
    ...
    for (parameters_iterator it = parameters_begin();
         it != parameters_end(); it++)
    {
