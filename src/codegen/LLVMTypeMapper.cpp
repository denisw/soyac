...
LLVMTypeMapper::LLVMTypeMapper(llvm::LLVMContext& context,
    ...
    : mContext(context), mDataLayout(dataLayout)
{
}

llvm::Type*
LLVMTypeMapper::valueType(Type* type)
{
    if (type == TYPE_BOOL)
...
llvm::Type*
LLVMTypeMapper::objectType(Type* type)
{
...
llvm::Type*
LLVMTypeMapper::getPointerSizeType()
{
    return mDataLayout.getIntPtrType(mContext);
}

llvm::Type*
LLVMTypeMapper::getStructOrClassLayoutType(UserDefinedType* type)
{
