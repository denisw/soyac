...
#ifndef SOYA_CODE_GENERATOR_H_
#define SOYA_CODE_GENERATOR_H_
...
private:
    ...
    llvm::Value* createBuiltInMethodCall(Expression* operand,
        const Name& methodName, Expression* argument = nullptr,
        Expression* argument2 = nullptr);
