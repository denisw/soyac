...
#ifndef SOYA_SYMBOL_TABLE_TEST_H_
#define SOYA_SYMBOL_TABLE_TEST_H_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

#include <analysis/SymbolTable.h>
#include "../ast/DummyDeclaredEntity.h"
#include "../ast/DummyStatement.h"
...
public:
    void setUp()
    {
        mTable = SymbolTable::get(nullptr, true);
    }
    ...
    void testLookupInEntityExcludesEnclosing()
    {
        ...
        CPPUNIT_ASSERT (mTable->lookup("bar", scope) == nullptr);
    }
