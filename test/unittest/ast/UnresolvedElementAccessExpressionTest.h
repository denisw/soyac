...
#ifndef SOYA_UNRESOLVED_ELEMENT_ACCESS_EXPRESSION_TEST_H_
#define SOYA_UNRESOLVED_ELEMENT_ACCESS_EXPRESSION_TEST_H_

#include <cppunit/TestFixture.h>
#include <cppunit/extensions/HelperMacros.h>

#include <ast/UnresolvedElementAccessExpression.h>
